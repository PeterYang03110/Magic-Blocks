...
const CalendarIcon = ({ className, viewBox, ...rest }) => {
  ...
  return (
    <SvgIcon viewBox={viewBox || '0 0 24 26'} {...rest} className={clsx(classes.root, className)}>
      <g filter='url(#filter0_d_260_301)'>
        <mask
          id='mask0_260_301'
      ...
      <defs>
        <filter
          ...
          />
          <feBlend mode='multiply' in2='BackgroundImageFix' result='effect1_dropShadow_260_301' />
          <feBlend
            mode='normal'
            in='SourceGraphic'
            in2='effect1_dropShadow_260_301'
            result='shape'
          />
        </filter>
      </defs>
