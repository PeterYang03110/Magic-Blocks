...
const BlueprintsPurchaseSuccessModal = ({
  open,
  setOpen
}) => {
      ...
      <div className={classes.container}>
        ...
        <div className={classes.balanceContainer}>
          ...
          <Typography className={classes.balance}>
            You have received the Magic Blocks Blueprint and Recipe: Silver Dragons Helmet
          </Typography>
        </div>
...
export default memo(BlueprintsPurchaseSuccessModal);
